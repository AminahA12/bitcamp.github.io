...
function changePage(inp) {
    inp.addEventListener("click", function() {
        ...
        var newURL = new URL("https://" + window.location.hostname + "/bitcamp.github.io/stats");
        newURL.searchParams.append("fips", fips);
        window.location.href = newURL;
    });
}

var texts = [
  "The map to the right shows which areas (at a county-level) have their respective housing markets most at risk to a combination of natural disasters and poverty. The risk index utilized incorporates and combines data regarding the poverty rate and number of natural disasters that have occurred in each U.S. county. \r\n\r\n The map highlights some major hotspots for housing market risk; Lousiana and northern Florida are the most evident ones, mainly due to the prevalence of hurricanes and flooding. Other notable but lesser hotspots include southern Florida, North and South Carolina, and Missisippi.",
  "This map details areas of federally-assisted housing by quantity on a county level. \r\n\r\n Overall, federally-assisted rental housing appears in much higher concentrations for the largest 4 counties compared to the rest - New York County at 114,167 homes, Bronx County at 111,768 homes, Los Angeles County at 108,388 homes, and Cook County at 92,983 homes respectively.",
  "This map showcases the change in Housing Price Index (HPI) by county from 2018 to 2022. \r\n\r\n On a state level, Florida counties have experienced the highest change in HPI on average. From a broader perspective though, there is a clear hotspot for HPI change which includes Tennessee, northern Georgia, and the westmost of North Carolina. On average, counties on the west of the U.S. experienced a higher change in HPI than counties on the east of the U.S. Notably, we found that a county's overall change in HPI was unrelated from the number of natural disasters it experienced - housing prices continued to rise nationwide regardless of their risk of natural disaster.",
  ...
  "This map measures counties based on a Subsidized Housing Risk Index, calculated on a logarithmic scale, accounting for subsidized housing concentration and natural disaster rate. \r\n\r\n Florida, California, Louisiana, and the general northeast of New England all have elevated risks of subsidized housing being damaged or destroyed."
]
